...
disp('SpdCtrl:');disp(SpdCtrl);
disp('PitCtrl:');disp(PitCtrl);
disp('NumBlade:');disp(NumBlade);
disp('NumSeg:');disp(NumSeg);
disp('RotorRad:');disp(RotorRad);
disp('HubRad:');disp(HubRad);
disp('HubHt:');disp(HubHt);
disp('Prated:');disp(Prated);
disp('ShaftTilt:');disp(ShaftTilt);
disp('PreCone:');disp(PreCone);
disp('SpdSt:');disp(SpdSt);
disp('SpdEnd:');disp(SpdEnd);
disp('SpdDel:');disp(SpdDel);
disp('OmgMin:');disp(OmgMin);
disp('OmgMax:');disp(OmgMax);
disp('rho:');disp(rho);
disp('CC:');disp(CC);
disp('Type:');disp(Type);
disp('Pv:');disp(Pv);
disp('Patm:');disp(Patm);
disp('WatDepth:');disp(WatDepth);
disp('CavSF:');disp(CavSF);
disp('Correct_3D:');disp(Correct_3D);
disp('ThickMethod:');disp(ThickMethod);
disp('CircleRoot:');disp(CircleRoot);
disp('minRootChord:');disp(minRootChord);
disp('maxRootChord:');disp(maxRootChord);
disp('RootTranSt:');disp(RootTranSt);
disp('RootTranEnd:');disp(RootTranEnd);

disp('StructuralOpt:');disp(StructuralOpt);
disp('RecordFailures:');disp(RecordFailures);

%blade element spacing
disp('RadialSpacing:');disp(RadialSpacing);

disp('Einput:');disp(Einput);
disp('allowableStrain:');disp(allowableStrain);
disp('matDensity:');disp(matDensity);
disp('STmin:');disp(STmin);
disp('STdel:');disp(STdel);
disp('SFstruct:');disp(SFstruct);
disp('DecreasingST:');disp(DecreasingST);

OptMethod = str2num(handles.OptMethod);
disp('OptMethod:');disp(OptMethod);
ProbDist = str2num(handles.ProbDist);
disp('ProbDist:');disp(ProbDist);
opened_file = get(handles.FlowDist_Filename,'String');    
disp('opened_file:');disp(opened_file);
    if strcmp(opened_file,'no file selected')
        OpenFile_Error = 1;
    else
        OpenFile_Error = 0;
...
disp('U_mean:');disp(U_mean);
disp('Weib_Umean:');disp(Weib_Umean);
disp('Weib_k:');disp(Weib_k);
disp('Weib_c:');disp(Weib_c);
    
disp('NumGens:');disp(NumGens);
disp('PopSize:');disp(PopSize);
disp('EliteCount:');disp(EliteCount);
disp('ParetoFraction:');disp(ParetoFraction);
disp('CrossFrc:');disp(CrossFrc);
disp('GATol:');disp(GATol);
disp('TwistLB:');disp(TwistLB);
disp('TwistUB:');disp(TwistUB);
disp('ChordLB:');disp(ChordLB);
disp('ChordUB:');disp(ChordUB);
disp('ThickLB:');disp(ThickLB);

disp('LB:');disp(LB);
disp('UB:');disp(UB);
         
disp('family:');disp(family);
disp('Thickness_values:');disp(Thickness_values);
filename_main = get(handles.Filename,'String');
disp('filename_main:');disp(filename_main);
