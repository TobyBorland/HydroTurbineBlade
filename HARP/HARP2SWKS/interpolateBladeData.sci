function [rOverR,r,preTwist,chord,percT,t,pitchAxis] = interpolateBladeData(fname, numSects, interpType)
...
offsetR = 7;
offsetC = 22;
harpOpt = struct('r', data(offsetR:$, 2 + offsetC),...
                 'rOverR', data(offsetR:$, 1 + offsetC),...
                 'preTwist', data(offsetR:$, 3 + offsetC),...
                 'chord', data(offsetR:$, 4 + offsetC),...
                 'percT', data(offsetR:$, 5 + offsetC),...
                 't', data(offsetR:$, 6 + offsetC),...
                 'pitchAxis', data(offsetR:$, 7 + offsetC),...
                 'length', data(offsetR:$, 7 + offsetC));
