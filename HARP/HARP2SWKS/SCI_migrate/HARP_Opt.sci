...
global SpdSt SpdEnd SpdDel OmgMin OmgMax Prated rho Patm Pv HubHt WatDepth Type...
       NumSeg HubRad Thickness_values ThickMethod RotorRad NumBlade family RootDir filename_main ...
       ...
       ParetoSet Pareto_filename OpenFile_Error RadialSpacing RecordFailures;
...
select get(eventdata.NewValue,'Tag')   //  Get Tag of selected object
    case 'True12'
        handles.DecreasingST = '1';
    case 'False12'
