...
C
      ...
      WRITE(*,*) 'Slen =', SLEN
      WRITE(*,*)
      WRITE(*,*) 'X-bending parameters:'
      WRITE(*,*) '  centroid   Xc  =', XC
      WRITE(*,*) '       max X-Xc  =', XMAX-XC
      WRITE(*,*) '       min X-Xc  =', XMIN-XC
      WRITE(*,*) '     solid Iyy   =', AIYY
      WRITE(*,*) '     skin  Iyy/t =', AIYYT
      XBAR = MAX( ABS(XMAX-XC) , ABS(XMIN-XC) )
      WRITE(*,*) ' solid Iyy/(X-Xc)=', AIYY /XBAR
      WRITE(*,*) ' skin Iyy/t(X-Xc)=', AIYYT/XBAR
C
      WRITE(*,*)
      WRITE(*,*) 'Y-bending parameters:'
      WRITE(*,*) '  centroid   Yc  =', YC
      WRITE(*,*) '       max Y-Yc  =', YMAX-YC
      WRITE(*,*) '       min Y-Yc  =', YMIN-YC
      WRITE(*,*) '     solid Ixx   =', AIXX
      WRITE(*,*) '     skin  Ixx/t =', AIXXT
      YBAR = MAX( ABS(YMAX-YC) , ABS(YMIN-YC) )
      WRITE(*,*) ' solid Ixx/(Y-Yc)=', AIXX /YBAR
      WRITE(*,*) ' skin Ixx/t(Y-Yc)=', AIXXT/YBAR
C
c      WRITE(*,*)
c      WRITE(*,*) '  power-avg X-Xc =', XEXINT
c      WRITE(*,*) '  power-avg Y-Yc =', YEXINT
C
      WRITE(*,*)
      WRITE(*,*) '    solid J     =', AJ
      WRITE(*,*) '    skin  J/t   =', AJT
